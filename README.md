...
# Heading Size
```
32-60px (can vary based on web design)
```

# Line spacing

```
Between 120-150% of font size
```

# Number of charcters per line

```
Between 45-90 charaters per line
...
choose san-serif or serif type face
...
Put text on images works for dark background images
overlay image with colour

# Icons

Use vector font icones whenever possible
...
# Hierarichy:
 ...
 Define where you want the audience want to look first
 Establish flow corresponds to content's message
 Use white space to build flow
...
# Responsive web design
 ...
 1. Fluid Grid: All layouts are sized in relative units such as percentages instead of units like pixels
 2. Flexible images are also sized in relative units.
 3. Media rules : allows us to specify different css rules for different browser widths.
